...
def render_page(handler, content, navbar):
    """
    ...
    """
    page = JINJA_ENV.get_template('templates/page.html', navbar)
    handler.response.out.write(page.render({'content': content, 'navbar': navbar}))